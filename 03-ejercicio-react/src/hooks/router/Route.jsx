...
El CÓDIGO del componente Route se IMPORTA una sola vez en App.jsx cuando se hace `import { Route } from './hooks/router/Route.jsx'`. Esto hace que luego podamos acceder al componente Route y que ya tengamos disponible el array VALID_ROUTES.

Una vez importado el código, el componente Route se EJECUTA cada vez que se llama en App.jsx, por lo tanto, como el array de VALID_ROUTES ya está disponible, no se vuelve a generar perdiendo su valor anterior. En cada ejecución de Route se agrega la ruta que viene por prop al array VALID_ROUTES.
